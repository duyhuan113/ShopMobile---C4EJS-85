...
function showDetailProduct(chosenProduct) {
    ...
    <div class="">
        <div class="item active">
            <a href="#"> <img src="${chosenProduct.img[0]}" alt="" style="width:100%"></a>
        </div>
        <div class="item">
            <a href="#"> <img src="${chosenProduct.img[1]}" alt="" style="width:100%"></a>
        </div>
        <div class="item">
            <a href="#"> <img src="${chosenProduct.img[2]}" alt="" style="width:100%"></a>
        </div>
    </div>
...
<div class="detail-infor">
    ...
    <form>
        <label><span>${chosenProduct.price} đ</span></label>
        <div>
